...
def runTests() {
    ...
    node(targetNode) {
        ...
        gitStatusWrapper(credentialsId: 'cd9678d2-1c7f-44e3-9fe5-8bdab3514013', gitHubContext: "Jenkins - pytest-${arch}", account: 'ROCmSoftwarePlatform', repo: 'torch_migraphx') {
            sh """
